...
export declare const ci16EditorDots: {
    name: '16-editor-dots';
    data: string;
};
...
export declare const ciParagraphOutlined: {
    name: 'paragraph-outlined';
    data: string;
};
