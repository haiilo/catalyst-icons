...
export declare const ciTestInboxDuotone: {
    name: 'test-inbox-duotone';
    data: string;
};
export declare const ciTestInbox: {
    name: 'test-inbox';
    data: string;
};
