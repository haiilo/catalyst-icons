...
export const ciThumbsUpLinkedInFilled = {
    ...
    data: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path fill="#000" fill-rule="evenodd" d="M10.895 3.59c.241-.927 1.247-1.716 1.975-1.095.695.594 1.425 1.967 2.053 5.23a.51.51 0 0 0 .495.414h2.32c2.076 0 3.525 2.057 2.825 4.012L19.898 14H20a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-4a2 2 0 0 1-1.99-1.797L14 20H9a1 1 0 0 1-1-1V9.943c0-.292.13-.566.338-.77 1.521-1.507 2.01-3.49 2.557-5.584Zm5.149 13.775V20h.879v-2.635zM20 18.525c0-1.442-1.374-1.39-1.758-.68v-.48h-.88V20h.88v-1.257c0-.755.88-.825.88 0V20H20zM16.483 16a.485.485 0 0 0-.483.486c0 .27.217.488.483.488a.485.485 0 0 0 .484-.488.485.485 0 0 0-.484-.486" clip-rule="evenodd"/><path fill="#000" d="M5.5 10a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5H5a2 2 0 0 1-2-2v-6a2 2 0 0 1 2-2z"/></svg>`,
};
