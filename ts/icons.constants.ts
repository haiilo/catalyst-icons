...
export const ciAnchorOutlined: {
  ...
  name: 'anchor-outlined',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 17"><path fill="#000" d="M7.5 3.75a.75.75 0 1 0-1.5 0zm-.75 12-.094.744a.8.8 0 0 0 .189 0zm6.714-3.77a.75.75 0 1 0-1.428-.46l.714.23zM3.75 6a.75.75 0 0 0 0 1.5zm6 1.5a.75.75 0 1 0 0-1.5zm-8.286 4.02a.75.75 0 0 0-1.428.46l.714-.23zM8.5 2.5h-.75a1 1 0 0 1-1 1V5a2.5 2.5 0 0 0 2.5-2.5zM6.75 4.25V3.5a1 1 0 0 1-1-1h-1.5A2.5 2.5 0 0 0 6.75 5zM5 2.5h.75a1 1 0 0 1 1-1V0a2.5 2.5 0 0 0-2.5 2.5zM6.75.75v.75a1 1 0 0 1 1 1h1.5A2.5 2.5 0 0 0 6.75 0zm0 3H6v12h1.5v-12zm0 12 .095.744c2.732-.347 5.735-1.764 6.62-4.514l-.715-.23-.714-.23c-.616 1.917-2.863 3.166-5.38 3.486zm-3-9v.75h6V6h-6zm3 9 .095-.744c-2.518-.32-4.765-1.569-5.38-3.486l-.715.23-.714.23c.884 2.75 3.887 4.167 6.62 4.514z"/></svg>`,
};
