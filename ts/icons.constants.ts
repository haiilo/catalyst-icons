...
export const ciAnchorOutlined: {
  ...
  name: 'anchor-outlined',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M13 6.75a1 1 0 1 0-2 0 1 1 0 0 0 2 0m1.5 0a2.5 2.5 0 0 1-1.75 2.385v1.115H15a.75.75 0 0 1 0 1.5h-2.25v5.367c.717-.152 1.397-.39 1.972-.71.797-.444 1.34-1.009 1.572-1.659a.75.75 0 1 1 1.412.504c-.393 1.1-1.256 1.91-2.256 2.466-1.002.557-2.195.893-3.365 1.027a.7.7 0 0 1-.17 0c-1.17-.134-2.363-.47-3.365-1.027-1-.556-1.863-1.366-2.256-2.466a.75.75 0 1 1 1.412-.504c.232.65.775 1.216 1.572 1.66.575.32 1.255.557 1.972.71V11.75H9a.75.75 0 0 1 0-1.5h2.25V9.135A2.5 2.5 0 1 1 14.5 6.75"/></svg>`,
};
