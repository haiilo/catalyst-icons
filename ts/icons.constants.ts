...
export const ciAnchorOutlined: {
  ...
  name: 'anchor-outlined',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 19"><path fill="#000" d="M8.5 3.75a.75.75 0 1 0-1.5 0zm-.75 14-.1.743q.1.015.201 0l-.1-.743Zm7.719-4.784a.75.75 0 0 0-1.437-.431l.718.215zM3.75 6a.75.75 0 0 0 0 1.5zm8 1.5a.75.75 0 0 0 0-1.5zM1.47 12.534a.75.75 0 1 0-1.437.431l.718-.215zM9.5 2.5h-.75a1 1 0 0 1-1 1V5a2.5 2.5 0 0 0 2.5-2.5zM7.75 4.25V3.5a1 1 0 0 1-1-1h-1.5A2.5 2.5 0 0 0 7.75 5zM6 2.5h.75a1 1 0 0 1 1-1V0a2.5 2.5 0 0 0-2.5 2.5zM7.75.75v.75a1 1 0 0 1 1 1h1.5A2.5 2.5 0 0 0 7.75 0zm0 3H7v14h1.5v-14zm0 14 .101.743c3.197-.435 6.62-2.203 7.618-5.527l-.719-.216-.718-.216c-.753 2.51-3.455 4.074-6.383 4.473zm-4-11v.75h8V6h-8zm4 11 .101-.743c-2.928-.399-5.63-1.963-6.382-4.473l-.719.216-.718.216c.997 3.324 4.42 5.092 7.617 5.527z"/></svg>`,
};
